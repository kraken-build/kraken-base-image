...
| libffi | apt-get (`apt.kubernetes.io`) | latest |
| libssl | apt-get (`apt.kubernetes.io`) | latest |
| llvm | apt-get (`apt.kubernetes.io`) | latest |
...
| pkg-config | apt-get (`apt.kubernetes.io`) | latest |
